		...
		<div class="row">
			<div class="col-12">
				...
				<div class="row listing-item wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s">
					<div class="col-12">
						<figure class="inner-img"><img src="images/SNAFCO-logo.jpg" alt="SNAFCO"/></figure>
						<div class="inner-contents"><h1 class="wow fadeInLeft" data-wow-duration="1.5s">About Us</h1>
