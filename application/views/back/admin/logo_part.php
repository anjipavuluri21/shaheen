...
<form >
    ...
    <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo translate('select_promotion_banners'); ?></h3>
                    </div>
                    <div class='panel-body'>
                        <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo translate('promotion_banner_one'); ?></td>
                            <td>
                                <div class="inner-div tr-bg img-fixed">
                                    <img class="img-responsive img-sm" src="<?php echo base_url(); ?>uploads/logo_image/logo_<?php echo $promotion_banner_one; ?>.png" id="promotion_banner_one" alt="User_Image" >
                                </div>
                            </td>
                            <td class="text-right">
                                <span class="btn btn-info btn-labeled fa fa-plus-circle" 
                                      onclick="ajax_modal('show_all/selectable', '<?php echo translate('select_logo'); ?>', '<?php echo translate('successfully_selected!'); ?>', 'logo_set_change', 'promotion_banner_one')">
                                          <?php echo translate('change'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            <td><?php echo translate('promotion_banner_two'); ?></td>
                            <td>
                                <div class="inner-div tr-bg img-fixed">
                                    <img class="img-responsive img-sm" src="<?php echo base_url(); ?>uploads/logo_image/logo_<?php echo $promotion_banner_two; ?>.png" id="promotion_banner_two" alt="User_Image" >
                                </div>
                            </td>
                            <td class="text-right">
                                <span class="btn btn-info btn-labeled fa fa-plus-circle" 
                                      onclick="ajax_modal('show_all/selectable', '<?php echo translate('select_logo'); ?>', '<?php echo translate('successfully_selected!'); ?>', 'logo_set_change', 'promotion_banner_two')">
                                          <?php echo translate('change'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            <td><?php echo translate('promotion_banner_three'); ?></td>
                            <td>
                                <div class="inner-div tr-bg img-fixed">
                                    <img class="img-responsive img-sm" src="<?php echo base_url(); ?>uploads/logo_image/logo_<?php echo $promotion_banner_three; ?>.png" id="promotion_banner_three" alt="User_Image" >
                                </div>
                            </td>
                            <td class="text-right">
                                <span class="btn btn-info btn-labeled fa fa-plus-circle" 
                                      onclick="ajax_modal('show_all/selectable', '<?php echo translate('select_logo'); ?>', '<?php echo translate('successfully_selected!'); ?>', 'logo_set_change', 'promotion_banner_three')">
                                          <?php echo translate('change'); ?>
                                </span>
                            </td>
                        </tr>
