				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" name="category_name"  
                            ...
                            <div class="form-group">
					<label class="col-sm-4 control-label" for="demo-hor-1">
                    	<?php echo translate('category_name_ar');?>
                        	</label>
					<div class="col-sm-6">
						<input type="text" name="category_name_ar"  
                        	value="<?php echo $row['category_name_ar'];?>" id="demo-hor-1" 
                            	class="form-control required" placeholder="<?php echo translate('category_name_ar');?>" >
					</div>
				</div>
                <div class="form-group">
